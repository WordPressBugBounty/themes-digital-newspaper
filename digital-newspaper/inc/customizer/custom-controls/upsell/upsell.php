 ...
 * @since 1.1.16
 */
if( ! class_exists( 'Digital_Newspaper_WP_Upsell_Control' ) ) :
    class Digital_Newspaper_WP_Upsell_Control extends Digital_Newspaper_WP_Base_Control {
        // control type
        public $type = 'upsell';
        public $features = [];
        public $button_label = '';
        ...
        public function render_content() {
            if( ! $this->button_label ) $this->button_label = esc_html__( 'View Premium', 'digital-newspaper' );
            if( ! $this->url ) $this->url = '//blazethemes.com/theme/digital-newspaper-pro/';
            ?>
